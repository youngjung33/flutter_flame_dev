...
- ✅ 블록 이동, 회전, 낙하
- ✅ **Hold Piece** (블록 보관 기능)
- ✅ **Ghost Piece** (예상 낙하 위치 표시)
- ✅ **Soft Drop** (부드러운 낙하, 아래 키 누르고 있기)
- ✅ **Next Queue** (다음 블록 5개 미리보기)
- ✅ 라인 클리어 및 점수 계산
...
#### 키보드 (데스크톱)
- **← →**: 블록 좌우 이동
- **↓**: Soft Drop (누르고 있으면 빠르게 낙하)
- **↑ / W**: 블록 회전
- **스페이스**: Hard Drop (즉시 낙하)
- **C / H**: Hold (블록 보관)
- **P**: 일시정지
...
- **3줄 클리어**: 500 × 레벨
- **4줄 클리어**: 800 × 레벨 (테트리스)
- **Soft Drop**: +1점 (블록당, 아래 키 누르고 있을 때)
- **Hard Drop**: +2점 (블록당, 스페이스바)
